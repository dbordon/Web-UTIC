<!DOCTYPE html>
   ...
   <?php
    ...
    <?php  
            ...
            $query = mysqli_query($conn, "SELECT *FROM v_noticias_destacadas ORDER BY fecha_publicacion DESC  LIMIT  $inicar, $n_por_pagina;")
  ...
  <table class="table table-dark">              
		<section class="ftco-section" id="pagina1">  
          ...
          <div class="col-lg-8 ftco-animate">            
            <h1 class="mb-3"><?php echo utf8_decode($titulo); ?></h1>
           <p>Categoría:<strong> <?php echo "$categoria"; ?></strong></p>
            ...
            <p> 
             <img src="http://www.utic.edu.py/webnoticias/<?php echo $foto; ?>" alt="" class="img-fluid">
            </p>
            <p align="left"><?php
            echo $texto;            
            ?></p>
  ...
  <div class=row>
    <nav  aria-label="Page navigation example">
      <ul class="pagination">
        ...
        <a class="page-link" href="destacados.php?pagina=<?php echo $i+1;?>"> <?php echo $i+1;?>  
        </a> 
        </li>
        <?php endfor ?>
        <li class="page-item <?php echo $_GET['pagina']>=$paginas ? 'disabled' : ''?>">    
        <a class="page-link" href="destacados.php?pagina=<?php echo $_GET['pagina']+1?> "></a>
        </li>
      </ul>
    </nav>
  </div>

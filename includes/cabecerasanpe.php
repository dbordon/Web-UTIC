...
<script>
  ...
  <title>UTIC Sede San Pedro del Ycuamandyyú</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="UTIC Sede San Pedro del Ycuamandyyú" />
    <meta name="robots" content="UTIC Sede San Pedro del Ycuamandyyúv" />
    <meta name="googlebot" content="UTIC Sede San Pedro del Ycuamandyyú" />
    <meta name="google-site-verification" content="sa6QINxSLtc2H3K_QDnEXF8-GRcLlVrV9bw5SVB8roM" /><meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
...
<div class="container">
  ...
  <a class="no-sticky-logo" href="http://www.utic.edu.py/v7" title="Universidad Tecnológica Intercontinental - Bienvenidos" rel="home">
                 <img src="../images/logo25.jpg" width="115px" class="img-fluid" alt="Responsive image">
   </a>  
     ...
     <!-- <form action="#" class="searchform order-lg-last">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
					...
					<li class="nav-item" ><a href="../postgrado.php" class="nav-link">Postgrados</a></li>
                    <li class="nav-item active"><a href="../sedes.php" class="nav-link">Sedes</a></li>
                     <!--  <li class="nav-item"><a href="blog.php" class="nav-link">Blog</a></li>-->
                    <li class="nav-item"><a href="https://www.messenger.com/t/utic.edu" class="nav-link">Contactos</a></li>
	        </ul>
	      </div>
  <nav>
...
<div class="container">
  <div class="row">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLongPERFMARK">
 							<a href="http://www.utic.edu.py/curriculum/index.php" target=_bank> <h5>Plantel de funcionarios</h5>
						</a></button>	    </div>
    <div class="col-sm">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLongPERFMARK">
    <a href="http://www.utic.edu.py/curriculum/docentes.php" target=_bank>		 <h5>Plantel docentes</h5>
					</a>	</button>	      
    </div>

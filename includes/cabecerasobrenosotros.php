...
<script>
  ...
  gtag('config', 'UA-164386867-1');
    ...
    <title>UTIC - Universidad Tecnológica Intercontinental - Carreras de grado, postgrados, Educación virtual</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Universidad Tecnológica Intercontinental - UTIC, Carreras de grado, programas postgrados, educación virtual" />
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <a class="dropdown-item active" href="sobrenosotros.php">Sobre Nosotros</a>

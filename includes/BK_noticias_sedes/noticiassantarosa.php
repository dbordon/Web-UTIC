<!DOCTYPE html>
   <!-- Cabecera -->
   <?php
    include 'cabecerasantarosanoti.php';
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('../includes/sedes/SantaRosa.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Noticias - Santa Rosa del Aguaray</h1>
             <p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="../sedes.php">Sedes <i class="ion-ios-arrow-forward"></i></a></span> <span> <a href="Santarosa.php">Santa Rosa del Aguaray <i class="ion-ios-arrow-forward"></i></a></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <?php  
          ...
          $inicar=($_GET['pagina']-1)*$n_por_pagina;
            ...
            $query = mysqli_query($conn, "SELECT *FROM v_noticias_santarosa LIMIT  $inicar, $n_por_pagina;")
                                            or die('error: '.mysqli_error($conn));

            $sql = "SELECT COUNT(*) total FROM v_noticias_santarosa";
...
<nav  aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a class="page-link" href="noticiassantarosa.php?pagina=<?php echo $_GET['pagina']-1?> ">
    Anterior
    </a>
    </li>
    <?php 
    ...
    for($i=0;$i<$paginas;$i++) :?>
      <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active': '' ?>">  
        <a class="page-link" href="noticiassantarosa.php?pagina=<?php echo $i+1;?>">
        <?php echo $i+1;?>  
        </a> 
      </li>

...
<script>
  ...
  gtag('config', 'UA-164386867-1');
    ...
    <title>UTIC - Ciclo de Webinars Gratuitos 2021</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="UTIC - Ciclo de Webinars Gratuitos 2021" />
    <meta name="robots" content="UTIC - Ciclo de Webinars Gratuitos 2021" />
    <meta name="googlebot" content="UTIC - Ciclo de Webinars Gratuitos 2021" />
...
<div class="container">
  ...
  <!-- <a class="navbar-brand" href="index.php">UTIC. <span>Universidad   </span></a>-->
	  <a class="no-sticky-logo" href="http://www.utic.edu.py/v7" title="Universidad Tecnológica Intercontinental - Bienvenidos" rel="home">
				 <img src="images/h1logo.png" width="115px" class="img-fluid" alt="Responsive image">
	  </a>  
	   ...
	   <!-- <form action="#" class="searchform order-lg-last">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
		  <ul class="navbar-nav mr-auto">
				  ...
				  <li class="nav-item" ><a href="carreras.php" class="nav-link">Carreras</a></li>
  ...
  <nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Ciclo de Webinars - Seminarios Gratuitos 2021, organizados por las Sedes</h1>
             <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span> <a href="webinars.php?pagina=1">Webinars - Seminarios <i class="ion-ios-arrow-forward"></i></a></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <?php           
          ...
          $inicar=($_GET['pagina']-1)*$n_por_pagina;
            ...
            $query = mysqli_query($conn, "SELECT *FROM v_seminarios WHERE estado='publicado' ORDER BY fecha_publicacion DESC  LIMIT  $inicar, $n_por_pagina;")
                                            or die('error: '.mysqli_error($conn));

            $sql = "SELECT COUNT(*) total FROM v_seminarios";
           ...
           while ($data2 = mysqli_fetch_assoc($query2))  {
            ...
            while ($data = mysqli_fetch_assoc($query)) {         
              $tema= utf8_encode($data['tema']);
              $sede= utf8_encode($data['descrip_sede']);
              $carrera= utf8_encode($data['descrip_orga']);
      ...
      <table class="table table-dark">              
		<section class="ftco-section" id="pagina1">  
          ...
          <div class="col-lg-8 ftco-animate">            
            <h3 class="mb-3">Tema: <?php echo utf8_decode($tema); ?></h3>
            <p align="left">  <img src="http://www.utic.edu.py/webnoticias/<?php echo $foto; ?>"  alt="" class="img-fluid">
           </p> 
            <p>Sede:<strong> <?php echo "$sede"; ?></strong></p>
            <p> Organización:<strong> <?php echo "$carrera"; ?></strong></p>
            <p> Autor/es:<strong> <?php echo "$autores"; ?></strong></p>
            <p> Fecha del evento:<strong> <?php echo "$fecha"; ?></strong>
            <p> Horario: <strong> <?php echo "$hora"; ?></strong></p>
            <p><strong>Si no pudiste participar, accede a la grabación</strong></p>
            <p>Enlace de la grabación: <a href="<?php echo $enlace; ?>" target=_bank> <strong><font color="black">Ver más</font></strong> </a></p>     
            <p align="left"><?php echo $video;?></p>
            <hr>    
            <?php
            }
            ?>
...
<nav  aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a class="page-link" href="webinarssedes.php?pagina=<?php echo $_GET['pagina']-1?> ">
    <<
    </a>
    </li>
    <?php 
    for($i=0;$i<$paginas;$i++) :?>
      <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active': '' ?>">  
        <a class="page-link" href="webinarssedes.php?pagina=<?php echo $i+1;?>">
        <?php echo $i+1;?>  
        </a> 
      </li>
     <?php

            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3 ftco-animate">
                  ...
                  <!--      <p class="mb-0"><a href="http://www.utic.edu.py/v7/archivos/instructivo%20alumno.pdf" target="_blank" class="btn btn-primary">Instructivo para cobranzas electrónicas <span class="ion-ios-arrow-round-forward"></span></a></p>-->
                        <hr>
                        <p class="mb-0"><a href="http://www.utic.edu.py/sigest" target="_blank" class="btn btn-primary">Realizá aquí tus Gestiones Estudiantiles <span class="ion-ios-arrow-round-forward"></span></a></p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/investigacion" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/1.jpg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="http://www.utic.edu.py/investigacion" target="_blank" class="btn btn-primary">Web Investigación<span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/repositorio" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/3.jpg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="http://www.utic.edu.py/repositorio" target="_blank" class="btn btn-primary">Repositorio institucional<span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/revista.ojs/" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/arandu.jpg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="http://www.utic.edu.py/revista.ojs/" target="_blank" class="btn btn-primary">Revista Arandu<span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/revista.recide/" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/portadarecide.jpeg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="http://www.utic.edu.py/revista.recide/" target="_blank" class="btn btn-primary">Revista Recide<span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/v7/hub.creativo.utic" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/flyer.jpeg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="http://www.utic.edu.py/v7/hub.creativo.utic/" target="_blank" class="btn btn-primary">Más información <span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="https://cigu2023.ufsc.br/es/" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/CIGU.webp');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="https://cigu2023.ufsc.br/es/" target="_blank" class="btn btn-primary">Más información <span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
            ...
            <div class="col-md-12 py-5 px-md-5">
                <div class="py-md-5">
                    <div class="heading-section heading-section-white ftco-animate mb-5">
                        ...
                        <br>
                        <a href="http://www.utic.edu.py/cire" target=_bank><button type="button" class="btn btn-light btn-lg" data-toggle="modal" data-target="#cire">Ingresar </button></a>
                        </p>
                    </div>
                </div>
            </div>
...
<p style="text-align: justify;"><span style="font-size: 10pt; font-family: verdana,geneva;"> <span style="line-height: 1.6em;">La Facultad de Derecho y Ciencias Sociales de la UTIC tiene como misi&oacute;n llevar a la pr&aacute;ctica el desarrollo de estrategias de avanzada en la docencia y la investigaci&oacute;n, orientadas a que el estudiante sea el art&iacute;fice de su propia formaci&oacute;n profesional. Es as&iacute;, que la Facultad pretende promover estudiantes y profesionales competentes, cr&iacute;ticos y comprometidos con la sociedad, quienes deben adquirir y desarrollar un conocimiento jur&iacute;dico vasto y actualizado, integral y din&aacute;mico, fruto de una actividad acad&eacute;mica y de investigaci&oacute;n, que les permita desempe&ntilde;arse &oacute;ptimamente en las distintas facetas de la profesi&oacute;n de abogado.</span><br /> <span style="line-height: 1.6em;">Puesto que se concibe al derecho como un instrumento al servicio del ser humano, de la democracia y del desarrollo, el estudiante de derecho debe tener una s&oacute;lida formaci&oacute;n moral, basados en principios de justicia, libertad, equidad, participaci&oacute;n y respeto a la pluralidad.</span></span></p>
...
<p style="text-align: justify;"><span style="font-size: 10pt; font-family: verdana,geneva;"> <strong style="line-height: 1.6em;">La Facultad de Derecho y Ciencias Sociales de la UTIC Se propone:</strong></span></p>
<ul style="text-align: justify;">
<li><span style="font-size: 10pt; font-family: verdana,geneva;">Contribuir a la transformaci&oacute;n social formando a la persona y al profesional en base a una escala de valores humanistas; buscando la excelencia educativa, enfatizando que el conocimiento del Derecho y&nbsp; la investigaci&oacute;n cient&iacute;fica debe estar al servicio de la humanidad.</span></li>
</ul>
<ul style="text-align: justify;">
<li class="_mce_tagged_br"><span style="font-size: 10pt; font-family: verdana,geneva;">Poner en pr&aacute;ctica modernas metodolog&iacute;as de ense&ntilde;anza-aprendizaje.</span></li>
</ul>
<ul style="text-align: justify;">
<li class="_mce_tagged_br"><span style="font-size: 10pt; font-family: verdana,geneva;">Formar estudiantes de alto rendimiento acad&eacute;mico, con capacidad para desarrollar habilidades de investigaci&oacute;n y soluci&oacute;n de problemas;&nbsp; enfocados en los problemas socio-jur&iacute;dicos del pa&iacute;s.</span></li>
</ul>
<ul style="text-align: justify;">
<li class="_mce_tagged_br" style="text-align: justify;"><span style="font-family: verdana,geneva; font-size: 10pt;">Promover profesionales con alto sentido de la justicia, la libertad, la equidad y el respeto a la participaci&oacute;n pluralista y democr&aacute;tica.<span style="color: #333333;"></span></span><br /><span style="font-size: 10pt; color: #333333; font-family: verdana,geneva;"></span></li>
</ul>
<p style="text-align: justify;"><span style="font-size: 10pt; color: #000000; font-family: verdana,geneva;">La Universidad Tecnol&oacute;gica Intercontinental, ante el desaf&iacute;o de formar profesionales con preparaci&oacute;n acorde a las demandas sociales actuales presenta su carrera de Derecho y Ciencias Sociales. La globalizaci&oacute;n de los sistemas econ&oacute;micos crea un marco distinto para el desarrollo para actividades profesionales en todas las &aacute;reas. En ese contexto, el especialista de Derecho, deber&aacute; aplicar una visi&oacute;n muchos m&aacute;s amplia a sus conocimientos legales y a la pr&aacute;ctica de su profesi&oacute;n. Ofrecemos esta nueva visi&oacute;n mediante nuestros planes de estudio delineados de acuerdo a pol&iacute;ticas educativas basadas en Legislaci&oacute;n Educativa Nacional, y en las principales tendencias mundiales en materia de formaci&oacute;n universitaria de la carrera de Derecho. La tecnolog&iacute;a aplicada al Derecho, constituir&aacute; unos de los principales fundamentos de nuestro enfoque acad&eacute;mico, as&iacute; como el protagonismo del educando en su propia formaci&oacute;n.<br /><br /></span></p>
...
<p style="text-align: center;"><span style="font-family: verdana,geneva; font-size: 14pt;"><span style="color: #000000; background-color: #ffffff;"></span><strong>Reglamento de Expo FTI</strong></span></p>
<p style="text-align: center;"><a href="images/facultades/REGLAMENTO FTI.pdf" target="_blank"><img src="images/facultades/expofti.jpg" alt="" width="250" height="250" style="display: block; margin-left: auto; margin-right: auto;" /></a></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <button  type="button" class="btn btn-secondary btn-lg" data-toggle="modal" data-target="#"><a href="archivos/reglamentos/1 ESTUDIANTE DE GRADO PRESENCIAL 2023.pdf" target=_blank>Ver el Reglamento</a></button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <button  type="button" class="btn btn-secondary btn-lg" data-toggle="modal" data-target="#"><a href="archivos/reglamentos/2 ESTUDIANTE DE GRADO A DIST Y SEM. 2023.pdf" target=_blank>Ver el Reglamento</a></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <button  type="button" class="btn btn-secondary btn-lg" data-toggle="modal" data-target="#"><a href="archivos/reglamentos/4 Reglamento Estudiantes Posgrado Mod. a Distancia y Semipresencial.pdf" target=_blank>Ver el Reglamento</a></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <button  type="button" class="btn btn-secondary btn-lg" data-toggle="modal" data-target="#"><a href="archivos/reglamentos/5 Reglamento de Docentes 2023.pdf" target=_blank>Ver el Reglamento</a></button>
                        </div>
                    </div>
                </div>
...
Educación Superior (CONES).</span></span></p>
    ...
    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Autoevaluación: </b>Consiste en la evaluación que la propia institución hace acerca de la situación de su
carrera en una sede. Para ello se conforma un Comité de Autoevaluación con la participación de docentes
de la carrera. El Informe de Autoevaluación es remitido a la ANEAES.
</p> <br>

    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Evaluación Externa:</b> Externa: La ANEAES designa, convoca y contrata a pares evaluadores del área que
corresponda, quienes serán comisionados para realizar la evaluación externa, verificando in situ el
contenido del Informe de Autoevaluación. Posteriormente el Comité de Pares Evaluadores elevará el informe con sus recomendaciones al Consejo Directivo.
</span></span></p>

    <p>&nbsp;<span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Informe Final:</b> La ANEAES analizará el informe del Comité de Pares Evaluadores y el Informe
de Autoevaluación y redactará la síntesis evaluativa.
Finalmente, el Consejo Directivo de la ANEAES decidirá sobre la acreditación fundada en los
informes. Los posibles resultados son:
</span></span></p>

    <p><span style="font-size: small;"><b>De acreditación:</b> cuando la ANEAES determina que la carrera en la sede cumple con los niveles
mínimos de calidad establecidos.</span></p>
...
acreditadas vigentes se detallan a continuación:</span></span></p>
    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Derecho:</b> Acreditada en la sede Caazapá, sede Hernandarias, sede Encarnación, sede Derecho (Asunción)
en proceso de Acreditación.</p>

    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Licenciatura en Análisis de Sistemas Informáticos:</b>Acreditada en las sedes de San Lorenzo y
Caaguazú.</span></span></p>
    
    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Licenciatura en Ciencias Administrativas: </b> Acreditada en la sede de San Lorenzo, Sede Fernando de la
Mora.</span></span></span></p>

    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 19.5px;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Licenciatura en Ciencias Contables:</b>  Acreditada en las Sedes de Fernando de la Mora, Dr. Juan E.
Estigarribia (Campo 9) y Hernandarias</span></span></p>

    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>Licenciatura en Enfermería:</b> Acreditada en las sedes de Capiatá, Caacupé, Horqueta,
Caazapá, María Auxiliadora, Caaguazú, Hernandarias y San Pedro del Ycuamandyjú.</span></span></p>
...
<p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"></span></span><span style="font-family: Arial, sans-serif;"><span style="font-size: small;"><b>¿Por qué hay carreras no acreditadas en la UTIC?
    ...
    <p class="western" lang="es-PY" style="margin-bottom: 0cm; line-height: 150%; text-align: left;"><span style="font-family: Arial, sans-serif;"><span style="font-size: small;">Los aranceles a ser abonados para la inscripción de las carreras para que estas puedan someterse a
evaluación son muy elevados. A esta inversión deben sumarse los gastos internos que conlleva el someter
una carrera. La UTIC actualmente se halla en una primera etapa de evaluación de sus carreras.
Gradualmente irá sometiendo al proceso a todas las sedes.</span></span></p>

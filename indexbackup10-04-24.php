    ...
    <section class="ftco-section bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="https://www.utic.edu.py/v7/innovaciontecnologica.utic/" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/flyer.jpeg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/v7/hub.creativo.utic" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/proyectoinnovacion.jpg');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="https://www.utic.edu.py/v7/innovaciontecnologica.utic/" target="_blank" class="btn btn-primary">Más información <span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        ...
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="https://cigu2023.ufsc.br/es/" target="_blank" class="btn btn-primary">XXII CIGU <span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="https://www.utic.edu.py/investigacion/IVsimposio/" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/investigacion/ivsimposio.webp');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
                                <p class="mb-0"><a href="https://www.utic.edu.py/investigacion/IVsimposio/" target="_blank" class="btn btn-primary">IV Simpósio <span class="ion-ios-arrow-round-forward"></span></a></p>
                                <p class="ml-auto mb-0">
                                </p>
                            </div>
                        </div>

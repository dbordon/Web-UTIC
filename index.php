    ...
    <section class="ftco-section bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 ftco-animate">
                    <div class="blog-entry">
                        <a href="http://www.utic.edu.py/v7/innovaciontecnologica.utic/6ta.html" target="_blank" class="block-20 d-flex align-items-end" style="background-image: url('images/popap/proyectoinnovacionv6.2.webp');">
                        </a>
                        <div class="text bg-white p-4">
                            <div class="d-flex align-items-center mt-4">
